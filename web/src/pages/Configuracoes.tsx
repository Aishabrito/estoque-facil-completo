        ...
        <div className="bg-white w-full max-w-2xl rounded-xl shadow-sm border border-red-100 overflow-hidden">
          ...
          <div className="p-4 md:p-6">
            <div className="flex flex-col md:flex-row items-start gap-4 mb-6">
              ...
              <div>
                <h3 className="font-medium text-gray-900">Resetar Sessão</h3>
                <p className="text-sm text-gray-500 mt-1 leading-relaxed">
                  Encerra sua sessão e redireciona para o login. Use se os dados estiverem incorretos.
                </p>
              </div>
            </div>
