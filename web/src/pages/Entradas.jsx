...
import { ArrowUpCircle, Calendar, PackageOpen, Loader2, Search, TrendingUp } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 flex items-center gap-4">
            <div className="p-3 bg-blue-50 rounded-xl">
              <ArrowUpCircle size={22} className="text-blue-600" />
            </div>
            <div>
            ...
            <table className="w-full text-left min-w-[600px]">
              <thead className="bg-gray-50/50 border-b border-gray-100 text-[10px] uppercase text-gray-400 font-black tracking-widest">
                <tr>
                  ...
                  <th className="p-5">Motivo / Obs</th>
