...
export default function RegistrarMovimentacao({ isOpen, onClose }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      onClose();
      // Dispara evento global para páginas que escutam atualizarem
    ...
    <div className="fixed inset-0 bg-black/60 z-[70] flex items-center justify-center p-4 backdrop-blur-sm">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden border border-gray-100">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          {/* Observação */}
          <div>
            <label className="text-xs font-black text-gray-400 uppercase tracking-wider mb-2 block">Observação <span className="font-normal normal-case text-gray-300">(opcional)</span></label>
            <div className="relative">
