...
const options = {
    definition: {
        ...
        info: {
            ...
            version: '1.0.0',
            description: 'API RESTful para o sistema ERP/PDV Estoque Fácil. Gerencia produtos, movimentações de estoque, vendas e usuários com controle de acesso por perfil (RBAC).',
        },
        servers: [
